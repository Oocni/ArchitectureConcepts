...
namespace ArchitectureConcepts.Onion.Core.Domain.Observations;
...
public interface IObservationsRepository
{
    ...
    Task<IReadOnlyCollection<Observation>> GetAllAsync(int? id, int limit, CancellationToken cancellationToken = default);
